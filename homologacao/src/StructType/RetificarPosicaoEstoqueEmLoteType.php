...
class RetificarPosicaoEstoqueEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoProtocoloType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\RetificarPosicaoEstoqueEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $retificarPosicaoEstoqueEmLoteTypeRegistroItem) {
            ...
            if (!$retificarPosicaoEstoqueEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
