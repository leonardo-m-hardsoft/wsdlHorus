...
class InformarSaidaMedicamentoEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\InformarSaidaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $informarSaidaMedicamentoEmLoteTypeRegistroItem) {
            ...
            if (!$informarSaidaMedicamentoEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
