...
class InformarPosicaoEstoqueEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\InformarPosicaoEstoqueEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $informarPosicaoEstoqueEmLoteTypeRegistroItem) {
            ...
            if (!$informarPosicaoEstoqueEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
