...
class InformarEntradaMedicamentoEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\InformarEntradaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $informarEntradaMedicamentoEmLoteTypeRegistroItem) {
            ...
            if (!$informarEntradaMedicamentoEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
