...
class RetificarEntradaMedicamentoEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoProtocoloType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\RetificarEntradaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $retificarEntradaMedicamentoEmLoteTypeRegistroItem) {
            ...
            if (!$retificarEntradaMedicamentoEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
