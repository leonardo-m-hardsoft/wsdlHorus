...
class RetificarDispensacaoMedicamentoEmLoteType extends AbstractStructBase
{
     ...
     * @param \HorusWSDL\Homologacao\StructType\IdentificacaoProtocoloType $identificacao
     * @return \HorusWSDL\Homologacao\StructType\RetificarDispensacaoMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        ...
        foreach ($values as $retificarDispensacaoMedicamentoEmLoteTypeRegistroItem) {
            ...
            if (!$retificarDispensacaoMedicamentoEmLoteTypeRegistroItem instanceof \HorusWSDL\Homologacao\StructType\Registro) {
